...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(
            ...
            required: ['summary', 'projection', 'weightChart', 'activity', 'dietAdherence', 'prescriptions', 'bmi', 'insights', 'actions', 'nullables'],
            properties: [
