...
const createDefaultSmsSettings = (t: TFunction): PaymentSettings => ({
  ...
  nutritionSmsTemplatesV2: {
    ...
    mealLogInactiveThreeDaysFirst: {
      enabled: true,
      body: t("panelSms.default.nutrition.mealLogInactiveThreeDaysFirst"),
      approval_status: "approved",
      approved_body: t("panelSms.default.nutrition.mealLogInactiveThreeDaysFirst"),
      approved_enabled: true,
      rejection_reason: null,
    },
    mealLogInactiveThreeDaysSecond: {
      enabled: true,
      body: t("panelSms.default.nutrition.mealLogInactiveThreeDaysSecond"),
      approval_status: "approved",
      approved_body: t("panelSms.default.nutrition.mealLogInactiveThreeDaysSecond"),
      approved_enabled: true,
      rejection_reason: null,
    },
...
const createNutritionTemplateMeta = (t: TFunction): Array<{
  ...
  {
    key: "mealLogInactiveThreeDaysFirst",
    title: t("panelSms.nutritionTemplate.mealLogInactiveThreeDaysFirst.title"),
    description: t("panelSms.nutritionTemplate.mealLogInactiveThreeDaysFirst.description"),
    placeholder: t("panelSms.nutritionTemplate.mealLogInactiveThreeDaysFirst.placeholder"),
  },
  {
    key: "mealLogInactiveThreeDaysSecond",
    title: t("panelSms.nutritionTemplate.mealLogInactiveThreeDaysSecond.title"),
    description: t("panelSms.nutritionTemplate.mealLogInactiveThreeDaysSecond.description"),
    placeholder: t("panelSms.nutritionTemplate.mealLogInactiveThreeDaysSecond.placeholder"),
  },
  {
...
const normalizeNutritionSmsTemplates = (
  ...
  mealLogInactiveThreeDaysFirst: value?.mealLogInactiveThreeDaysFirst ?? (value as Record<string, SmsTemplateConfig> | undefined)?.mealLogInactiveThreeDays ?? defaults.nutritionSmsTemplatesV2!.mealLogInactiveThreeDaysFirst,
  mealLogInactiveThreeDaysSecond: value?.mealLogInactiveThreeDaysSecond ?? defaults.nutritionSmsTemplatesV2!.mealLogInactiveThreeDaysSecond,
